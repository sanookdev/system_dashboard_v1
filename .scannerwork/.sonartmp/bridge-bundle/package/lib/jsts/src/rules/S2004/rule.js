            ...
            ':function'(node) {
                ...
                if (nestedStack.length === max + 1) {
                    ...
                    context.report({
                        ...
                        message: (0, helpers_1.toEncodedMessage)(`Refactor this code to not nest functions more than ${max} levels deep.`, secondaries.map(n => ({
                            loc: (0, locations_1.getMainFunctionTokenLocation)(n, n.parent, context),
