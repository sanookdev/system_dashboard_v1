...
class CookieFlagCheck {
    ...
    checkSensitiveObjectArgument(callExpression, argumentIndex) {
        ...
        const cookieProperty = (0, _1.getProperty)(objectExpression, 'cookie', this.context);
        if (!cookieProperty) {
            return;
        }
    ...
    checkFlagOnCookieExpression(cookiePropertyValue, firstArgument, objectExpression, callExpression) {
        const flagProperty = (0, _1.getProperty)(cookiePropertyValue, this.flag, this.context);
        if (flagProperty) {
