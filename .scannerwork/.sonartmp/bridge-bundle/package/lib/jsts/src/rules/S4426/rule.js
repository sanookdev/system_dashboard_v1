...
exports.rule = {
    ...
    create(context) {
        ...
        function checkRsaAndDsaOptions(algorithm, options) {
            const modulusProperty = (0, helpers_1.getProperty)(options, 'modulusLength', context);
            ...
            const divisorProperty = (0, helpers_1.getProperty)(options, 'divisorLength', context);
        ...
        function checkEcCurve(options) {
            const namedCurveProperty = (0, helpers_1.getProperty)(options, 'namedCurve', context);
